...
class _ChatPageState extends StateMVC<ChatPage> {
  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();

  bool check_button = false;
  consultantcontroller _con;

  _ChatPageState() : super(consultantcontroller()) {
    _con = controller;
  }
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        margin:
                        EdgeInsets.only(left: Configs.calcheight(17 / 2)),
                        child: FlatButton(
                          color: (check_button
                              ? Color(0xFF00A68C)
                  ...
                  child: check_button
                    ...
                    child: Column(
                      children: [
                        Container(
                          padding:
                          EdgeInsets.only(top: Configs.calcheight(28), left: Configs.calcheight(28), right:Configs.calcheight(28)),
                          child: Row(
                            mainAxisAlignment:
                        ...
                        Expanded(
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                String img_icon;
                                switch (
                                _con.old_consultArr[index].type) {
                                  case 'typing':
                                    img_icon =
                                  ...
                                  case 'voice':
                                    img_icon =
                                    'assets/images/ic_voice_white.png';
                                    break;
                                  case 'video':
                                    img_icon =
                                    'assets/images/ic_video_white.png';
                                    break;
                                }
                                return Container(
                                  decoration: BoxDecoration(
                                  ...
                                  padding: index != 0 ? EdgeInsets.all(
                                      Configs.calcheight(16)): EdgeInsets.only(left: Configs.calcheight(16), right: Configs.calcheight(16), bottom: Configs.calcheight(16)),
                                  child: Row(
                                    mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                    children: [
                                      Row(
                                        children: [
                                          Container(
                                            width:
                                            Configs.calcwidth(125),
                                            height:
                                            Configs.calcheight(72),
                                            margin: EdgeInsets.only(
                                                left: Configs.calcwidth(
                                                    12)),
                                            child: FlatButton(
                                              color: Blue10,
                                              padding:
