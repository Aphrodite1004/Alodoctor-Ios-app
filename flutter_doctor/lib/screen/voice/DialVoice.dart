...
import 'package:flutter_doctor/screen/voice/VoicePage.dart';
import 'package:flutter_doctor/utils/Configs.dart';
import 'package:flutter_doctor/utils/colors.dart';

class DialVoice extends StatefulWidget {
  @override
  _DialVoiceState createState() => _DialVoiceState();
}

class _DialVoiceState extends State<DialVoice> {
                            ...
                            case "Pickup":
                              {
                                ...
                                return VoicePage(
                                    ...
                                    callType: 'VoiceCall',
                                    response: snapshot.data.documents[0]['response']
                                );
                              }
                              break;
                            case "Decline":
