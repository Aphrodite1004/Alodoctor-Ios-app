            ...
            Expanded(
              ...
              Container(
                child: Column(
                  children: [
                    Container(
                      padding: EdgeInsets.only(left: Configs.calcheight(28), right: Configs.calcheight(28), top: Configs.calcheight(28)),
                      child: Row(
              ...
              Container(
                child: Column(
                  children: [
                    Container(
                      padding: EdgeInsets.only(top: Configs.calcheight(28), left: Configs.calcheight(28), right: Configs.calcheight(28)),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Container(
