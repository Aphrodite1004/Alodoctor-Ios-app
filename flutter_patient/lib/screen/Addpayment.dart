...
class _AddpaymentState extends State<Addpayment> {
            ...
            children: [
              ...
              Material(
                child: Container(
                  ...
                  width: Configs.calcwidth(533),
                  height: Configs.calcheight(77),
                  alignment: Alignment.center,
                  padding: EdgeInsets.only(left: Configs.calcheight(25)),
                  child: TextField(
                    controller: cardnumontroller,
                    keyboardType: TextInputType.number,
              ...
              Container(
                width: Configs.calcwidth(535),
                margin: EdgeInsets.only(top: Configs.calcheight(53)),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.symmetric(
                                  horizontal: Configs.calcheight(15)),
                              child: Text(
                                '/',
                                style: TextStyle(
                                    color: Gray06,
              ...
              Container(
                width: Configs.calcwidth(535),
                margin: EdgeInsets.symmetric(
                    vertical: Configs.calcheight(16)),
                alignment: Alignment.centerRight,
                child: Text(
                  'Last 3 digit on the back',
                  style: TextStyle(
                      color: Gray06, fontSize: Configs.calcheight(25)),
                ),
              ),
              Container(
                width: Configs.calcwidth(535),
  ...
  add_money() async {
    String cardnums = cardnumontroller.text.trim().replaceAll(' ', '');
    String exp_month = mmcontroller.text.trim();
    String exp_year = '20' + yycontroller.text.trim();
