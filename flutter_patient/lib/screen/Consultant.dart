  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar:  _currentIndex == 2 ? Bottombar(0) : Bottombar(1),
      ),
    );
  }
    ...
    if(pushText == 'update'){
      ...
      if(messages == 'voice' || messages == 'video'){
        ...
        var platformChannelSpecificsAndroid = new AndroidNotificationDetails(
            ...
            priority: Priority.high);
        // @formatter:on
        var platformChannelSpecificsIos = new IOSNotificationDetails(sound: 'audio.aiff');
        var platformChannelSpecifics = new NotificationDetails(android: platformChannelSpecificsAndroid, iOS: platformChannelSpecificsIos);
