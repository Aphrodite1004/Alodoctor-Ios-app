...
class _DoctordetailState extends State<Doctordetail> {
  ...
  void initState() {
    ...
    for(int i = 0; i < Configs.umodel.countries.length; i++){
      if(Configs.con_doctor1.country_id == Configs.umodel.countries[i].id) {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Flag(country_id, height: Configs.calcheight(30), width: Configs.calcheight(45), fit: BoxFit.fill),
                           InkWell(
