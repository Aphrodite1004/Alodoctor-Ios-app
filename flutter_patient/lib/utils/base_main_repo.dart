...
class BaseMainRepository {
  ...
  Future<String> getconsultant() async {
    ...
    String result = await NetworkHelper.makePostRequest(
        APIEndPoints.consultanturl, values);
    return result;
  }

  Future<String> patient_startConsultant(int id, int id2, int menulist_id, String ty) async {
    String platform ='';
    if (Platform.isAndroid) {
      platform = 'android';
  ...
  Future<String>  patient_addmoney(String cardnums, String exp_month, String exp_year, String cvc, String amount) async{
    Map<String, Object> values = {
      'cardnumber': cardnums,
      'exp_month': exp_month,
      'exp_year': exp_year,
  ...
  Future<String> changepssword(String t_old, String t_new) async {
    ...
    String result = await NetworkHelper.makePostRequest(APIEndPoints.changepasswordurl, values);
    return result;
  }

  Future<String> patient_register(String t_fullname, String t_pass, String t_email) async {
    Map<String, Object> values = {
      'name': t_fullname,
      'password': t_pass,
      'email': t_email,
    };
    String result = await NetworkHelper.makePostRequest(APIEndPoints.patient_register, values);
    return result;
  }
